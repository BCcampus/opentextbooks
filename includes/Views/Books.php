...
class Books
{
    ...
    public function displayOneTextbook()
    {
        ...
        if (!array_key_exists(0, $data)) {
            ...
            $html .= "<p><strong>Adaptations: </strong><a href='https://open.bccampus.ca/open-textbook-101/adapting-an-open-textbook/'>Support for adapting an open textbook<i class='glyphicon glyphicon-book'></i></a></p>";
    ...
    public function displayContactFormTitles(array $num_reviews_per_book)
    {
        ...
        foreach ($this->books->getResponses() as $data) {
            ...
            if (in_array(substr($data['uuid'], 0, 5), $omit)) {
                continue;
