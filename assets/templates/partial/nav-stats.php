<ul class="nav nav-tabs no-bullets" role="tablist">
    ...
    <li  class="nav-item" role="presentation"><a class="nav-link" href="#opentext_stats" data-toggle="tab" aria-controls="opentextbc" role="tab">Pressbooks</a></li>
    <li  class="nav-item" role="presentation"><a class="nav-link" href="#open_stats" data-toggle="tab" aria-controls="open" role="tab">Collection</a></li>
